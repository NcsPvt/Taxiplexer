 ...
 * using the application. Your application should call {@link Eula#showEula(android.app.Activity)} in the onCreate() method of the first activity. If the user accepts the
 * EULA, it will never
