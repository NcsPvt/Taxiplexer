 ...
 */
package itcurves.ncs.org.apache.commons.collections4.comparators;
 ...
 * <p>
 * Calling a method that adds new Comparators or changes the ascend/descend sort <i>after compare(Object, Object) has been called</i> will result in an
 * UnsupportedOperationException. However, <i>take care</i> to not alter the underlying List of Comparators or the BitSet that defines the sort order.
 * <p>
 * Instances of ComparatorChain are not synchronized. The class is not thread-safe at construction time, but it <i>is</i> thread-safe to perform multiple comparisons
...
public class ComparatorChain<E> implements Comparator<E>, Serializable {
	 ...
	 * equivalent to mine.
	 * <p>
	 * This implementation returns <code>true</code> iff <code><i>object</i>.{@link Object#getClass() getClass()}</code> equals <code>this.getClass()</code>, and the
	 * underlying comparators and order bits are equal. Subclasses may want to override this behavior to remain consistent with the {@link Comparator#equals(Object)}
	 * contract.
	 * 
	...
	public boolean equals(final Object object) {
		...
		if (object.getClass().equals(this.getClass())) {
			...
			return (null == orderingBits ? null == chain.orderingBits : orderingBits.equals(chain.orderingBits)) && (null == comparatorChain ? null == chain.comparatorChain : comparatorChain
				.equals(chain.comparatorChain));
		}
		return false;
	}
