...
public class MJM_Return {
	...
	private final Integer TransactionType = 2;
	...
	public String SendReturnRequest() {
		...
		try {
			...
			for (IMessageListener list : AVL_Service.msg_listeners.values())
				list.exception("[exception in SendReturnRequest in MJM_Return][SendReturnRequest][" + e.getLocalizedMessage() + "] ");
		}
