...
public class MJM_VoidSale {
	...
	private final Integer TransactionType = 5;
	...
	public String SendVoidSaleRequest() {
		String xmlString = "";
		...
		try {
			...
			for (IMessageListener list : AVL_Service.msg_listeners.values())
				list.exception("[exception in SendVoidSaleRequest in MJM_VoidSale][SendVoidSaleRequest][" + e.getLocalizedMessage() + "] ");
		}
