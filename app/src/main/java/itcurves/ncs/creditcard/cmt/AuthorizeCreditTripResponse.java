...
public class AuthorizeCreditTripResponse {
	...
	public AuthorizeCreditTripResponse() {
		set_ErrorMessage("");
		set_RequestEndTime("");
	...
	public void ParseAuthorizeCreditTripResponse(SoapSerializationEnvelope envelope) throws SoapFault {
		...
		if (_ResultCode.equals(successVar)) {
			...
			if (_ResponseType.equalsIgnoreCase("1")) {
				_CardType = result123.getProperty("CardType").toString();
