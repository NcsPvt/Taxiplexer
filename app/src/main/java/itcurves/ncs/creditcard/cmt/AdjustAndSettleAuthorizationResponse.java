...
public class AdjustAndSettleAuthorizationResponse {
	...
	public AdjustAndSettleAuthorizationResponse()
	{
		set_ErrorMessage("");
		set_RequestEndTime("");
	...
	public void ParseAdjustAndSettleAuthorizeResponse(SoapSerializationEnvelope envelope) throws SoapFault
	{
